...
import copy
# import skfmm
from src.xing_loss import xing_loss
...
from src.vectorize_utils import \
    get_experiment_id, \
    get_path_schedule, \
    edict_2_dict, \
...
def parse_args():
    ...
    parser.add_argument("--config", type=str, default="resource/config/LIVE.yml")
    parser.add_argument("--experiment", type=str, default="experiment_32x4")
    parser.add_argument("--seed", type=int)
    parser.add_argument("--target", type=str, help="target image path", required=True)
    parser.add_argument('--log_dir', metavar='DIR', default="output/vectorized/")
    parser.add_argument('--initial', type=str, default="random", choices=['random', 'circle'])
    parser.add_argument('--signature', nargs='+', type=str, required=True)
